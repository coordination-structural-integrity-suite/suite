...
If you want to formally assess your organization's structural health across all ten standards and produce a gap map and advancement roadmap: use the **[Coordination Structural Integrity Suite Assessment](tensegrity-suite/prompts/suite/suite-assessment-stage-1-orientation-0_1_0.md)**. This is a five-stage structured process. Each stage produces a downloadable output. Start with Stage 1, which orients you to the full process before any assessment begins. The assessment works best after completing the Explore prompt; it builds on the vocabulary and self-knowledge the exploration develops. The same assessment also exists as a [single resumable prompt](tensegrity-suite/prompts/suite/suite-assessment-0_1_1.md): start fresh and Stage 1 begins automatically, or paste a prior session output to resume.
...
**Machine-readable layer.** For an AI harness, an agentic client, or a developer that consumes the standards as data rather than prose, every standard also ships a machine-readable fetch surface: a per-standard JSON Schema, a typed register of its provisions, and conformant and non-conformant examples, indexed by a family manifest. This layer lives as one source in a separate repository, **[Polymathie-Studio/tools](https://github.com/Polymathie-Studio/tools)** (sources under `machine-readable/`, the generated schemas under `schema/csis/`). Start from the family manifest, which lists every standard and points at its schema set: **[csis-manifest.json](https://raw.githubusercontent.com/Polymathie-Studio/tools/main/schema/csis/csis-manifest.json)**. The prose standards in this repository remain the canonical source; the machine-readable layer is generated from them and points back here.
...
| --- | --- | --- |
| **[Precision-First Design Standard](tensegrity-suite/compressive/standards/standards-3_0-precision-first-2_4_3.md)** | 2.4.3 | Every element of a coordination system increases the precision with which its dynamics can be observed, classified, and acted upon. The suite's meta-standard. |
| **[Adverse-Signal Engagement Principle Core Standard](tensegrity-suite/compressive/standards/standards-3_0-adverse-signal-engagement-0_7_13.md)** | 0.7.13 | Signals that contradict current models are engaged, not suppressed or reframed. |
| **[Structural Consent Legibility Standard](tensegrity-suite/compressive/standards/standards-3_0-structural-consent-0_3_25.md)** | 0.3.25 | Consent to participation is structurally distinguishable from consent to specific terms, outcomes, and power arrangements. |
| **[Information Asymmetry Classification Standard](tensegrity-suite/compressive/standards/standards-3_0-information-asymmetry-0_1_26.md)** | 0.1.26 | The structural types of information asymmetry present in a system are classified and disclosed. Six primary classes. |
| **[Structural Power Obligation Standard](tensegrity-suite/compressive/standards/standards-3_0-structural-power-obligation-0_1_26.md)** | 0.1.26 | Power across three independent dimensions is legible and contestable by participants who hold less of it. |
| **[Regenerative Obligation Standard](tensegrity-suite/compressive/standards/standards-3_0-regenerative-obligation-0_1_8.md)** | 0.1.8 | Extraction of contributor capacity is matched by regenerative return: non-fungible, proximate, and embedded. |
| **[Coordination Scaling Standard](tensegrity-suite/compressive/standards/standards-3_0-coordination-scaling-0_1_5.md)** | 0.1.5 | The structural conditions each Dunbar-scale threshold requires are installed before crossing it. |

<details>
<summary><b>Precision-First Design Standard</b>: the full architecture</summary>

Closes precision failure in two directions. A precision deficit occurs when instrument terms are under-specified: violations become undetectable and gaps remain permanently exploitable. A precision imposition occurs when an instrument is over-specified: compliance can be demonstrated while the coordination purpose remains unserved. Ten corollaries covering both failure directions. Addresses Ostrom's second design principle at the standards level.

[Read the full standard](tensegrity-suite/compressive/standards/standards-3_0-precision-first-2_4_3.md)
</details>

<details>
<summary><b>Adverse-Signal Engagement Principle Core Standard</b>: the full architecture</summary>

Requires engagement with signals that contradict current models rather than suppression or reframing. Closes the gap between appearing to address problems and actually addressing them. Section 3.3.10 names cross-component aggregate failure as its own signal class: individual component conformance does not guarantee aggregate conformance, and an aggregate outcome inconsistent with a chain's declared risk reduction is an adverse signal at the aggregate level regardless of component-level results. Addresses Ostrom's design principles 5, 6, and 7 at the standards level.

[Read the full standard](tensegrity-suite/compressive/standards/standards-3_0-adverse-signal-engagement-0_7_13.md)
</details>
...
[Read the full standard](tensegrity-suite/compressive/standards/standards-3_0-structural-consent-0_3_25.md)
</details>
...
| --- | --- | --- |
| **[Sensemaking Standard](tensegrity-suite/generative/standards/standards-3_0-sensemaking-1_1_23.md)** | 1.1.23 | What sensemaking must structurally provide for coordination to remain self-correcting. Five invariants, three scales. |
| **[Four Batteries Capacity Standard](tensegrity-suite/generative/standards/standards-3_0-four-batteries-capacity-0_3_7.md)** | 0.3.7 | Four orthogonal capacity dimensions (Personal, Relational, Contribution, Mission) conditioned for surplus, not just non-failure. |
| **[Conflict Transformation Standard](tensegrity-suite/generative/standards/standards-3_0-conflict-transformation-0_2_10.md)** | 0.2.10 | The structural conditions under which conflict transformation capacity develops and is sustained. |
...
[Read the full standard](tensegrity-suite/generative/standards/standards-3_0-sensemaking-1_1_23.md)
</details>
...
[Read the full standard](tensegrity-suite/generative/standards/standards-3_0-four-batteries-capacity-0_3_7.md)
</details>
...
[Read the full standard](tensegrity-suite/generative/standards/standards-3_0-conflict-transformation-0_2_10.md)
</details>
...
2026-07-02 (second pass): Publish pass for the remaining eight standards, bringing every published standard current with its maintained version. Precision-First Design Standard v2.4.0 to v2.4.3 (temporal-dynamic boundary class widened to the whole class; Corollary 7 re-anchored to the Terminology Conventions Reference names registry; typological declaration header updated); Adverse-Signal Engagement v0.7.11 to v0.7.13 (Section 3.3.10, cross-component aggregate failure as a named signal class; typological declaration repair); Information Asymmetry v0.1.25 to v0.1.26, Regenerative Obligation v0.1.7 to v0.1.8, Structural Consent v0.3.24 to v0.3.25, Conflict Transformation v0.2.9 to v0.2.10, Four Batteries v0.3.6 to v0.3.7, Sensemaking v1.1.22 to v1.1.23 (all: typological declaration repair from the 2026-06-22 combined sweep). README corrections in the same pass: Precision-First corollary count nine to ten (Corollary 10, Claim-Object Grounding, shipped in v2.4.0); ASEP description extended for Section 3.3.10; CROSS repository links updated to its current home at github.com/CrossWalkri/CROSS.

2026-07-02: Publish pass for two standards. Coordination Scaling Standard updated from v0.1.0 to v0.1.5: Board/Dome vocabulary replaced with Minimum and Maximum Conditions (v0.1.1); nominal and robust Effective Radius defined as distinct constructs and named trigger conditions added to CSS-Instrumented (v0.1.2); primary detection signals, de-crossing rules, and contextual baseline statement added (v0.1.3); affected-party reach axis added as Section 10 with the functional reach ceiling and the proxy or guardian channel minimum condition above it (v0.1.4); typological declaration repaired (v0.1.5). Structural Power Obligation Standard updated from v0.1.24 to v0.1.26: scale trigger added to the Section 4.1 proxy and guardian channel, graduated by the affected-party reach ceiling (v0.1.25); typological declaration repaired (v0.1.26). Both standard descriptions in this README extended accordingly. This pass also repairs the cross-references in CRAFT 0.4.3 (published separately at github.com/CrossWalkri/craft-meta-standard), which cite Coordination Scaling Standard Section 10 and the Structural Power Obligation Standard Section 4.1 scale-graduated channel.

2026-05-15: CROSS moved to its own repository at github.com/CrossWalkri/CROSS. The cross/ subfolder has been removed from this repository. The Suite-level documents section link updated to point to the external repo. CROSS remains independently adoptable without adopting the Suite.

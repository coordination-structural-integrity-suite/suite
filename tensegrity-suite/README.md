...
Eight standards that specify the structural conditions coordination systems must meet to remain functional under real-world pressure. Developed in the course of building the Proof of Coordination protocol.

The suite has two structural layers:

**Tensegrity Compressive Standards** (`compressive/`) specify the minimum structural floors a coordination system must hold. Five standards. Their absence makes specific failure modes predictable rather than merely possible.

...
What was the most recent adverse signal this system received, and what happened to it? If that question cannot be answered from the system's records (no record of recent adverse signals, no documentation of their processing, and no record of their outcomes), the standard is not met. The inability to answer the question is itself an adverse signal.
